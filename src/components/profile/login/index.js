...
const LogIn = ({ users, loggedIn, setLoggedIn, setActiveUser}) => {
    ...
    return (
        <div className="logIn">
            ...
            <div>
                <input type="password" className="logInInputs" placeholder="Password" ref={passwordElement} />
                <p>Forget your Password?</p>
            </div>
            <div>
                <button className="logBtn" onClick={handleLogIn}>Log in</button><br />
            </div>
            <p className="or">Or</p>
            ...
            <p>By continuing you agree to Our's <a className="terms">Terms of Service</a>, <a className="terms">Privacy Police</a> </p>
            <p>
                You dont have an account yet, then
                <NavLink to={"/signup"} className="logBtn">Sign up</NavLink>
            </p>
        </div>
    )
}
