...
import { setMessageRead, setMessageUnread } from "../../../../redux/ducks/userDuck";
import { api } from "../../../../api";
                        ...
                        <>
                            ...
                            >
                                ...
                                <div className='admin-sender-info'>
                                    ...
                                    <div className='admin-message-details event-id-link' onClick={() => handleNavigateId(msg.eventId)}>
                                        id: {msg.eventId}
                                    </div>
                                </div>
                                ...
                                {!msg.status ? (
                                    ...
                                    <button className='button' onClick={() => handleMarkAsUnread(msg.id)}>
                                        Unmark
                                    </button>
                                )}
                            </div>
